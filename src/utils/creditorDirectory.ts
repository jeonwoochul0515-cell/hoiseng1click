...
const DIRECTORY: CreditorInfo[] = [
  ...
  // ─── 채권추심회사 ───
  { name: '고려신용정보', address: '서울특별시 강남구 테헤란로 114', phone: '02-558-8800' },
  { name: '하나에이앤에스', address: '서울특별시 중구 을지로 66', phone: '02-6905-6000' },
  { name: '우리신용정보', address: '서울특별시 중구 소공로 51', phone: '02-2008-5000' },
  { name: '한국신용정보원', address: '서울특별시 중구 세종대로 124', phone: '02-3705-5000' },
  { name: '유앤아이신용정보', address: '서울특별시 영등포구 국제금융로 10', phone: '02-3215-1500' },
  { name: '아주채권관리', address: '서울특별시 강남구 테헤란로 230', phone: '02-6913-0700' },
  { name: '한맥자산관리', address: '서울특별시 강남구 삼성로 511', phone: '02-557-5001' },
  { name: 'SBI저축은행채권관리', address: '서울특별시 강남구 테헤란로 326', phone: '02-2179-2200' },
  { name: '에이원신용정보', address: '서울특별시 강남구 역삼로 234', phone: '02-6949-0700' },
  { name: '동양파이낸셜대부', address: '서울특별시 중구 을지로 170', phone: '1588-3600' },
  { name: '제이케이신용정보', address: '서울특별시 영등포구 여의대로 108', phone: '02-780-0088' },
  { name: '코리아크레딧뷰로', address: '서울특별시 종로구 새문안로3길 30', phone: '02-708-1000' },
  { name: 'KCB', address: '서울특별시 종로구 새문안로3길 30', phone: '02-708-1000' },
