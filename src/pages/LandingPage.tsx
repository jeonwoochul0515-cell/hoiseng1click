...
function TestimonialsSection() {
  const testimonials = [
    {
      stars: 5,
      text: '의뢰인한테 서류 받으려고 전화 돌리는 시간이 사라졌습니다. CODEF 인증 한 번이면 채무 현황이 알아서 정리되니까 진짜 편해요.',
      name: '정OO 법무사',
      location: '부산 연제',
    },
    {
      stars: 4,
      text: '나이가 있어서 새 프로그램 배우기 걱정했는데, 생각보다 쉬웠습니다. 의뢰인 링크 보내면 알아서 입력하니까 실수도 줄고요.',
      name: '최OO 법무사',
      location: '부산 동래',
    },
    {
      stars: 5,
      text: 'HWP 파일이 법원 양식 그대로 나와서 수정할 게 거의 없어요. 예전에 한글 파일 만지느라 밤새던 게 엊그제 같은데.',
      name: '박OO 법무사',
      location: '부산 해운대',
    },
  ];
